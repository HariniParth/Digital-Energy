...
function get_header_html_text() {
	...
	if (kind == 'HTML') {
		...
		var sidePositionPanel = 'left',
			...
			h2_font_size="16",
			h3_font_color="#216da7",
			h3_font_size="14",
			// global style
			content_font_style="Signika",
			content_font_size="12",
			content_line_spacing='1.5', // em
			content_font_color="#b5b5b5",
			content_links_font_color="#94bbd9",
                        //background style
			...
			background_Full_Image = "background: url('images/background.png')",
